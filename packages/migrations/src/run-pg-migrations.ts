...
import migration_2023_10_02T14_41_41_schema_checks_dedup from './actions/2023.10.02T14.41.41.schema-checks-dedup';
...
export const runPGMigrations = (args: { slonik: DatabasePool; runTo?: string }) =>
  runMigrations({
    ...
    migrations: [
      ...
      migration_2023_10_02T14_41_41_schema_checks_dedup,
    ],
  });
